// The Seoulful bookmarklet — runs on the user's current tab when they
...
export const BOOKMARKLET_READABLE = `(function () {
  var t = (document.title || "")
    ...
    .trim();
  if (!t) {
    alert("Seoulful could not detect a product name from this page.");
    return;
  }
  window.open(
